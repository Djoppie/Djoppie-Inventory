                ...
                >
                  ...
                  {formData.quantity > 1 && (
                    <Typography variant="caption" color="text.secondary" sx={{ mt: 1.5, display: 'block' }}>
                      Names will be numbered: "{formData.assetName} 1", "{formData.assetName} 2", etc.
                      {formData.serialNumberPrefix && (
                        <>
                          <br />
                          Serial numbers will follow the same pattern: {formData.serialNumberPrefix}-0001, {formData.serialNumberPrefix}-0002, etc.
                        </>
                      )}
                    </Typography>
                  )}
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                <TextField
                  ...
                  required
                />
                <FormControl sx={{ flex: '0 1 150px' }} required>
