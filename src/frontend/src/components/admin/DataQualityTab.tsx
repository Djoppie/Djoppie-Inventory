...
/**
 * Asset Data Quality content (categories filter + summary + brand breakdown
 * + backfill controls). Extracted from the legacy dashboard dialog so it can
 * be hosted both inside that dialog and as a tab in the Admin Data Quality
 * page.
 */
