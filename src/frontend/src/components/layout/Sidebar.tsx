  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        matchPaths: ['/operations/swaps'],
      },
      {
        label: 'Reports',
        icon: <AssessmentIcon />,
        path: ROUTES.DEPLOYMENT_HISTORY,
        matchPaths: ['/operations/swaps/history', '/operations/deployments'],
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        matchPaths: ['/operations/requests/onboarding'],
      },
      {
        label: 'Offboarding',
        icon: <PersonRemoveIcon />,
        path: ROUTES.REQUESTS_OFFBOARDING,
        matchPaths: ['/operations/requests/offboarding'],
      },
      {
        label: 'Reports',
        icon: <AssessmentIcon />,
        path: ROUTES.REQUESTS_REPORTS,
        matchPaths: ['/operations/requests/reports'],
      },
    ],
  },
  {
