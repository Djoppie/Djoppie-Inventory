...
const routeLinks: Record<string, string> = {
  ...
  'assets': ROUTES.INVENTORY,
  'operations': ROUTES.OPERATIONS_ROLLOUTS,
  'rollouts': ROUTES.OPERATIONS_ROLLOUTS,
  'workplaces': ROUTES.PHYSICAL_WORKPLACES,
  'requests': ROUTES.REQUESTS,
  'autopilot': ROUTES.INVENTORY_CLOUD_AUTOPILOT,
  'admin': ROUTES.ADMIN_ASSETS,
  'cloud': ROUTES.INVENTORY_CLOUD,
};
