    ...
    () =>
      createTheme({
        palette: {
          ...
          ...(mode === 'light'
            ? {
              // Light mode - Professional Neumorphic Style
              primary: {
              ...
              background: {
                default: '#F8F9FA', // Soft light gray
                paper: '#F8F9FA',
              },
              text: {
                primary: '#212529',
            ...
            : {
              // Dark mode - Subtle Neumorphic Dark
              primary: {
                main: '#FF9233',
                light: '#FFAD66',
                dark: '#FF7700',
        ...
        components: {
            ...
            styleOverrides: {
              root: {
                ...
                boxShadow: mode === 'light'
                  ...
                  : '6px 6px 12px rgba(0, 0, 0, 0.6), -6px -6px 12px rgba(255, 255, 255, 0.03)',
                border: 'none',
                ...
                '&:hover': {
                  boxShadow: mode === 'light'
                    ...
                    : '10px 10px 20px rgba(0, 0, 0, 0.7), -10px -10px 20px rgba(255, 255, 255, 0.03), 0 4px 16px rgba(255, 119, 0, 0.35)',
                ...
                '&:active': {
                  ...
                  boxShadow: mode === 'light'
                    ...
                    : '3px 3px 6px rgba(0, 0, 0, 0.5), -3px -3px 6px rgba(255, 255, 255, 0.03)',
                },
              },
              contained: {
              ...
              outlined: {
                ...
                borderWidth: '2px',
                background: mode === 'light' ? '#F8F9FA' : '#1f2329',
                '&:hover': {
              ...
              root: {
                '& .MuiOutlinedInput-root': {
                  ...
                  boxShadow: mode === 'light'
                    ...
                    : 'inset 3px 3px 6px rgba(0, 0, 0, 0.7), inset -3px -3px 6px rgba(255, 255, 255, 0.02)',
                  transition: 'all 0.25s cubic-bezier(0.4, 0, 0.2, 1)',
                  '& fieldset': {
                    borderColor: 'transparent',
                  },
                  '&:hover fieldset': {
                    borderColor: mode === 'light' ? 'rgba(255, 119, 0, 0.3)' : 'rgba(255, 146, 51, 0.3)',
                  },
                  '&.Mui-focused': {
                    boxShadow: mode === 'light'
                      ? 'inset 3px 3px 6px rgba(0, 0, 0, 0.12), inset -3px -3px 6px rgba(255, 255, 255, 0.8), 0 0 0 2px rgba(255, 119, 0, 0.2)'
                      : 'inset 3px 3px 6px rgba(0, 0, 0, 0.7), inset -3px -3px 6px rgba(255, 255, 255, 0.02), 0 0 0 2px rgba(255, 146, 51, 0.3)',
                  },
          ...
          MuiChip: {
            styleOverrides: {
              ...
              filled: {
                background: mode === 'light'
                  ? 'linear-gradient(145deg, #E9ECEF, #DEE2E6)'
                  : 'linear-gradient(145deg, #2a2d33, #1f2329)',
              },
            },
          },
          MuiAppBar: {
            styleOverrides: {
              root: {
                ...
                backgroundColor: mode === 'light' ? '#F8F9FA' : '#1a1d23',
                boxShadow: mode === 'light'
            ...
            styleOverrides: {
              ...
              elevation3: {
                boxShadow: mode === 'light'
                  ...
                  : '10px 10px 20px rgba(0, 0, 0, 0.7), -10px -10px 20px rgba(255, 255, 255, 0.03)',
              },
            },
          },
          MuiIconButton: {
            ...
            styleOverrides: {
              root: {
                ...
                boxShadow: mode === 'light'
                  ...
                  : 'inset 2px 2px 4px rgba(0, 0, 0, 0.6), inset -2px -2px 4px rgba(255, 255, 255, 0.02)',
              },
              bar: {
                borderRadius: 12,
          ...
          MuiBottomNavigation: {
            styleOverrides: {
              root: {
                background: mode === 'light' ? '#F8F9FA' : '#1a1d23',
                boxShadow: mode === 'light'
                  ? '0 -4px 12px rgba(0, 0, 0, 0.1)'
                  : '0 -4px 12px rgba(0, 0, 0, 0.5)',
                borderTop: 'none',
