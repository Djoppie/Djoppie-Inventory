...
-- This adds missing columns and tables to Azure SQL Database
-- Run this script manually in Azure SQL if automatic migrations fail
...
-- Record migration as applied in EF Core history
