...
namespace DjoppieInventory.Infrastructure.Migrations
{
    ...
    [Migration("20260428121933_AddAssetRequestLifecycle")]
    partial class AddAssetRequestLifecycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DjoppieInventory.Core.Entities.AssetCodeCounter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DjoppieInventory.Core.Entities.AssetRequestLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DjoppieInventory.Core.Entities.LeaseContract", b =>
                {
                    ...
                    b.Property<string>("LeaseScheduleNumber")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTime>("PlannedLeaseEnd")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("LeaseScheduleNumber")
                        .IsUnique();

                    b.HasIndex("PlannedLeaseEnd");
            ...
            modelBuilder.Entity("DjoppieInventory.Core.Entities.Asset", b =>
                {
                    ...
                    b.HasOne("DjoppieInventory.Core.Entities.LeaseContract", "LeaseContract")
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("DjoppieInventory.Core.Entities.AssetRequestLine", b =>
                {
                    ...
                    b.HasOne("DjoppieInventory.Core.Entities.AssetRequest", "AssetRequest")
                        .WithMany("Lines")
